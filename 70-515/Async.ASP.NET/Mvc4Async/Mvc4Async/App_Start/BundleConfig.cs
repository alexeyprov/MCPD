...
namespace Mvc4Async
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            jsBundle.Include("~/Scripts/query.unobtrusive*");
            jsBundle.Include("~/Scripts/jquery.validate*");
            jsBundle.Include("~/Scripts/AjaxLogin.js");
            bundles.Add(jsBundle);

            var mobileJsBundle = new ScriptBundle("~/bundles/mobileJs");
            ...
            var mobileCssBundle = new StyleBundle("~/Content/mobileCss");
            mobileCssBundle.Include("~/Content/jquery.mobile*");
            bundles.Add(mobileCssBundle);

            const string themePath = "~/Content/themes/base/";
            var themeBundle = new StyleBundle(themePath + "css");
