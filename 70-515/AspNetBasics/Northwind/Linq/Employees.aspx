<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employees.aspx.cs" Inherits="Northwind.UI.Linq.EmployeesPage" Title="Employees" MasterPageFile="~/Northwind/Master/Northwind.master"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="NorthwindContentPlaceHolder" >
	...
	<div>
		<asp:LinqDataSource ID="srcEmployees" runat="server" ContextTypeName="Northwind.Data.Linq.NorthwindContext"
