<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shippers.aspx.cs" Inherits="Northwind.UI.Linq.ShippersPage" Title="Shippers" MasterPageFile="~/Northwind/Master/Northwind.master"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="NorthwindContentPlaceHolder" >
	...
	<asp:LinqDataSource ID="srcShippers" runat="server" ContextTypeName="Northwind.Data.Linq.NorthwindDataContext"
		TableName="Shippers" EnableObjectTracking="false" 
		Select="new (ShipperID, CompanyName, Phone)"
		OnContextCreating="srcShippers_ContextCreating" />
