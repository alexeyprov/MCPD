<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employees.aspx.cs" Inherits="Northwind.UI.Ado.EmployeesPage" Title="Employees" MasterPageFile="~/Northwind/Master/Northwind.master"%>
 ...
 WHERE EMPLOYEEID = @EMPLOYEEID"
		...
		<asp:Panel runat="server" ID="pnlOrders" Visible="false">
			...
			<asp:GridView ID="grdOrders" runat="server" AutoGenerateColumns="False" 
				...
				ClientIDMode="Predictable" ClientIDRowSuffix="ORDERID"
