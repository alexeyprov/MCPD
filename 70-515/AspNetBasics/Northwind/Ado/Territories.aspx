<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Territories.aspx.cs" Inherits="Northwind.UI.Ado.TerritoriesPage" Title="Territories" MasterPageFile="~/Northwind/Master/Northwind.master"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="NorthwindContentPlaceHolder" >
	<h2>Territories</h2>
		<p>
			...
			<a href="http://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.sqldatasource.aspx" target="_blank" >SqlDataSource</a>.
    ...
    <div>
		<asp:Panel ID="pnlData" runat="server">
			...
			<!-- Use DataReader mode for SqlDataSource. Quicker access, but no caching, paging or sorting is enabled -->	    
