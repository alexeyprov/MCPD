<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderDetails.aspx.cs" Inherits="Northwind.UI.Entities.OrderDetailsPage" Title="Order Details" MasterPageFile="~/Northwind/Master/Northwind.master"%>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="NorthwindContentPlaceHolder" >
	<h2>Order Details</h2>
	<p>This page illustrates usage of stored procedures with <i>Entity Framework</i>.</p>
	<div>
