<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Northwind.UI.Entities.DefaultPage"
...
<asp:Content ContentPlaceHolderID="NorthwindContentPlaceHolder" runat="server">
	<h2>Northwind DB Samples (Entities Framework)</h2>
	<p>This page illustrates basics of ASP.NET data binding using LINQ to Entities.</p>
	...
	<ul>
        ...
        <li><a href="Territories.aspx">Master-Detail <i>EntityDataSource</i> demo</a></li>
        <li><a href="Customers.aspx">CRUD <i>EntityDataSource</i> demo</a></li>
    </ul>
