...
// 
namespace HelloSilverlight.HelloSilverlight.Server {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="HelloSilverlight.Server.TestService")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface TestServiceChannel : HelloSilverlight.HelloSilverlight.Server.TestService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TestServiceClient : System.ServiceModel.ClientBase<HelloSilverlight.HelloSilverlight.Server.TestService>, HelloSilverlight.HelloSilverlight.Server.TestService {
        ...
        System.IAsyncResult HelloSilverlight.HelloSilverlight.Server.TestService.BeginGetServerTime(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetServerTime(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.DateTime HelloSilverlight.HelloSilverlight.Server.TestService.EndGetServerTime(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetServerTime(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((HelloSilverlight.HelloSilverlight.Server.TestService)(this)).BeginGetServerTime(callback, asyncState);
        }
        
        private object[] OnEndGetServerTime(System.IAsyncResult result) {
            System.DateTime retVal = ((HelloSilverlight.HelloSilverlight.Server.TestService)(this)).EndGetServerTime(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override HelloSilverlight.HelloSilverlight.Server.TestService CreateChannel() {
            return new TestServiceClientChannel(this);
        }
        
        private class TestServiceClientChannel : ChannelBase<HelloSilverlight.HelloSilverlight.Server.TestService>, HelloSilverlight.HelloSilverlight.Server.TestService {
            
            public TestServiceClientChannel(System.ServiceModel.ClientBase<HelloSilverlight.HelloSilverlight.Server.TestService> client) : 
                    base(client) {
            }
