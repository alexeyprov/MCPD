if not exists(Select * from [$(AspNetDb)].[dbo].[aspnet_SchemaVersions])
begin
	insert into [$(AspNetDb)].dbo.aspnet_SchemaVersions (Feature, CompatibleSchemaVersion, IsCurrentVersion)
		values('common', 1, 1)
	insert into [$(AspNetDb)].dbo.aspnet_SchemaVersions (Feature, CompatibleSchemaVersion, IsCurrentVersion)
