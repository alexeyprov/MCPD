...
if not exists(select * from [$(AspNetDb)].dbo.aspnet_Applications where ApplicationId = '8b2e549a-c283-46f2-b481-25136daa9059')
	insert into [$(AspNetDb)].dbo.aspnet_Applications(ApplicationName, LoweredApplicationName, ApplicationId)
		values('/', '/', '8b2e549a-c283-46f2-b481-25136daa9059')

if not exists (select * from [$(AspNetDb)].dbo.aspnet_Roles where RoleId = N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e')
	INSERT [$(AspNetDb)].[dbo].[aspnet_Roles] ([ApplicationId], [RoleId], [RoleName], [LoweredRoleName], [Description]) 
...
if not exists (select * from [$(AspNetDb)].dbo.[aspnet_Users] where UserId = N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e')
	INSERT [$(AspNetDb)].[dbo].[aspnet_Users] ([ApplicationId], [UserId], [UserName], [LoweredUserName], [MobileAlias], [IsAnonymous], [LastActivityDate]) 
...
if not exists(select * from [$(AspNetDb)].dbo.aspnet_UsersInRoles where userId = N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e' and roleId = N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e')
	INSERT [$(AspNetDb)].[dbo].[aspnet_UsersInRoles] ([UserId], [RoleId]) 
		VALUES (N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e', N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e')

if not exists (select * from [$(AspNetDb)].dbo.[aspnet_Membership] where UserId = N'6c82524a-b1e0-4b20-97b1-dbdf0dadad8e')
	INSERT [$(AspNetDb)].[dbo].[aspnet_Membership] ([ApplicationId], [UserId], [Password], [PasswordFormat], [PasswordSalt], [MobilePIN], [Email], [LoweredEmail], [PasswordQuestion], [PasswordAnswer], [IsApproved], [IsLockedOut], [CreateDate], [LastLoginDate], [LastPasswordChangedDate], [LastLockoutDate], [FailedPasswordAttemptCount], [FailedPasswordAttemptWindowStart], [FailedPasswordAnswerAttemptCount], [FailedPasswordAnswerAttemptWindowStart], [Comment])
