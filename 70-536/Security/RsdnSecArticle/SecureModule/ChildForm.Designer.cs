namespace SecureModule
{
	partial class ChildForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnClose.Location = new System.Drawing.Point(136, 68);
			...
			// btnCallback
			// 
			this.btnCallback.Location = new System.Drawing.Point(12, 68);
			this.btnCallback.Name = "btnCallback";
			this.btnCallback.Size = new System.Drawing.Size(83, 23);
			this.btnCallback.TabIndex = 2;
			this.btnCallback.Text = "&Run Callback";
			this.btnCallback.UseVisualStyleBackColor = true;
			this.btnCallback.Click += new System.EventHandler(this.btnCallback_Click);
			// 
			// ChildForm
			// 
			this.AcceptButton = this.btnCallback;
