...
namespace CASDemands
{
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        private string RandomFileName()
        {
            ...
            return @"C:\Documents and Settings\AlexeyPr\" + myRandom.Next().ToString();
        }
        ...
        [FileIOPermission(SecurityAction.Demand, Write = @"C:\Documents and Settings\AlexeyPr\12345")]
        private void declarativeCreateFile()
        {
            createFile(@"C:\Documents and Settings\AlexeyPr\12345");
        }

        private void imperativeDemandButton_Click(object sender, System.EventArgs e)
        {
            string fileName = RandomFileName();
            IPermission writeFilePermission = new FileIOPermission(FileIOPermissionAccess.Write, fileName);
