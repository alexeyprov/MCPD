...
namespace CustomBinding
{
    public partial class MainForm : Form
	{
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			_bindings.Add(new SimpleBinding(_currentBook, "Author", txtAuthor, "Text"));
			_bindings.Add(new SimpleBinding(_currentBook, "Title", txtTitle, "Text"));
			_bindings.Add(new SimpleBinding(_currentBook, "Isbn", txtIsbn, "Text"));
			_bindings.Add(new SimpleBinding(_currentBook, "PageCount", txtPageCount, "Text"));
