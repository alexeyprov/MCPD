...
namespace LocalSTS
{
    ...
    public class CustomSecurityTokenServiceConfiguration : SecurityTokenServiceConfiguration
    {
        ...
        public CustomSecurityTokenServiceConfiguration()
        {
            ...
            TokenIssuerName = "LocalSTS";
            SigningCredentials = new X509SigningCredentials(CustomSecurityTokenServiceConfiguration.Certificate);
            ServiceCertificate = CustomSecurityTokenServiceConfiguration.Certificate;
        }
    }
}
