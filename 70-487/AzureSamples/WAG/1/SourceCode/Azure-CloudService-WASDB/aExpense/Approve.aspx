...
<asp:Content ID="Content2" ContentPlaceholderID="ContentPlaceholder" runat="server">
 ...
 <div id="expenselist">    
    <asp:GridView Width="100%" ID="MyExpensesGridView" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="ExpensesDataSource" AllowPaging="True" DataKeyNames="Id" OnRowDataBound="OnExpenseRowDataBound">
        <Columns>        
    ...
    <asp:ObjectDataSource ID="ExpensesDataSource" runat="server"
        DataObjectTypeName="AExpense.Model.Expense" SelectMethod="GetExpensesForApproval" 
        TypeName="AExpense.DataAccessLayer.ExpenseRepository" 
