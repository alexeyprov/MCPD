...
namespace AExpense.Providers
{
    ...
    public class TableStorageSessionStateProvider : SessionStateStoreProviderBase
    {
        ...
        public override SessionStateStoreData GetItem(HttpContext context, string id, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actions)
        {
            ...
            SessionStateStoreData sessionStateStoreData = this.GetSession(context, id, out locked, out lockAge, out lockId, out actions, false);
        ...
        public override SessionStateStoreData GetItemExclusive(HttpContext context, string id, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actions)
        {
            ...
            SessionStateStoreData sessionStateStoreData = this.GetSession(context, id, out locked, out lockAge, out lockId, out actions, true);
            return sessionStateStoreData;
        }
        ...
        public override void SetAndReleaseItemExclusive(HttpContext context, string id, SessionStateStoreData item, object lockId, bool newItem)
        {
            ...
            this.providerRetry(() =>
            {
                ...
                if (!newItem)
                {
                    session = this.GetSession(id, svc);
                ...
                session.BlobName = this.GetBlobNamePrefix(id) + Guid.NewGuid().ToString("N");
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            this.tableName = Configuration.GetStringValueWithGlobalDefault(
                                                                           ...
                                                                           Configuration.DefaultSessionTableName, 
                                                                           false);
            ...
            this.containerName = Configuration.GetStringValueWithGlobalDefault(
                                                                               ...
                                                                               Configuration.DefaultSessionContainerName, 
                                                                               false);
            ...
            try
            {
                ...
                lock (ThisLock)
                {
                    this.tableStorage.CreateTableIfNotExist<SessionRow>(this.tableName);
                }
            ...
            {
                string exceptionDescription = Configuration.GetInitExceptionDescription(
                                                                                        account.Credentials,
                                                                                        account.TableEndpoint,
                                                                                        account.BlobEndpoint);
                string table = this.tableName ?? "no session table name specified";
                string container = this.containerName ?? "no container name specified";
                Log.Write(
                        EventKind.Error, 
        ...
        public override void ReleaseItemExclusive(HttpContext context, string id, object lockId)
        {
            ...
            {
                TableServiceContext svc = this.CreateDataServiceContext();
                SessionRow session = this.GetSession(id, svc);
                ReleaseItemExclusive(svc, session, lockId);
            }
            catch (InvalidOperationException e)
            {
        ...
        // retry policies
        private SessionStateStoreData GetSession(HttpContext context, string id, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actions, bool exclusive)
        {
            SecUtility.CheckParameter(ref id, true, true, false, Configuration.MaxStringPropertySizeInChars, "id");
            ...
            try
            {
                ...
                using (MemoryStream stream = this.blobProvider.GetBlobContent(session.BlobName, out properties))
