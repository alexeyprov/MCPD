...
{
    [TestClass]
    public class Azure_CloudServiceSQLServerTest
    {
        private string baseUrl = "https://127.0.0.1:444";
        string employeeOneAlias = @"ADATUM\johndoe";
        string managerAlias = @"ADATUM\mary";
        string newUserAlias = @"ADATUM\newuser";
        public Azure_CloudServiceSQLServerTest()
        {
        ...
        #region Modified values for this project
