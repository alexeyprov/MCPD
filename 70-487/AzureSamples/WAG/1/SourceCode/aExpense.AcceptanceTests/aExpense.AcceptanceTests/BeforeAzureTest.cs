...
{
    [TestClass]
    public class BeforeAzureTest
    {
        private string baseUrl = "https://localhost/aExpense/";
        string employeeOneAlias = @"ADATUM\johndoe";
        string managerAlias = @"ADATUM\mary";
       // string newUserAlias = @"ADATUM\newuser";
        //public BeforeAzureTest()
        //{
        ...
        public void CheckAddReceiptInAddExpense()
        {
           ...
           // string receiptImage = "Receipt Image";
            using (var ie = new IE(this.baseUrl, false))
            {
                ...
                Assert.IsTrue(titleCell.ContainingTableRow.TableCells[5].Text.Contains("Pending"));
                this.CheckAndLogout(ie);
            }
        }
        ...
        public void AddandApproveExpense()
        {
            ...
            using (var ie = new IE(this.baseUrl, false))
            {
                ...
                Assert.IsTrue(titleCell.ContainingTableRow.TableCells[5].Text.Contains("Ready for Processing"));
                this.CheckAndLogout(ie);
            }
        }
        ...
        public void AddExpenseCheckRequiredFields()
        {
            ...
            using (var ie = new IE(this.baseUrl, false))
            {
                ...
                Assert.IsTrue(ie.ContainsText(errorMessage));
        ...
        //        AmountField(ie).TypeText(random.Next(1000, 2000).ToString());
        //        AddExpenseButton(ie).Click();
        //        Assert.IsTrue(ie.ContainsText("The problem has been logged in the machine Event Log "), "Shows the potentially dangerous exception on page");
