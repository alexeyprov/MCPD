...
namespace Microsoft.ServiceBus.AccessControlExtensions
{
    public abstract class IdentityReference : Claim
    {
        ...
        {
            var o = obj as IdentityReference;
            if (o != null)
            {
                return System.String.CompareOrdinal(o.ClaimType, this.ClaimType) == 0 && System.String.CompareOrdinal(o.ClaimValue, this.ClaimValue) == 0 &&
                       System.String.CompareOrdinal(o.IssuerName, this.IssuerName) == 0;
            }
            return false;
        }
