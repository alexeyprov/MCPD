...
namespace Microsoft.ServiceBus.AccessControlExtensions
{
    ...
    public static class ManagementServiceExtensions
    {
        ...
        /// </summary>
        /// <param name="svc"> The management service </param>
        ...
        public static RelyingParty CreateRelyingParty(this ManagementService svc, string name, string realm, string reply, RelyingPartyTokenType tokenType, bool requireEncryption)
        {
            ...
            var relyingParty = new RelyingParty { AsymmetricTokenEncryptionRequired = requireEncryption, Name = name, TokenType = tokenType.ToString(), TokenLifetime = 3600, };
