...
namespace ServiceModelEx.ServiceBus
{
   ...
   {         
      ...
      void DiscoveryRequest(string contractName,string contractNamespace,Uri[] scopesToMatch,Uri replayAddress)
      {
         Channel.OnDiscoveryRequest(contractName,contractNamespace,scopesToMatch,replayAddress);
      }
