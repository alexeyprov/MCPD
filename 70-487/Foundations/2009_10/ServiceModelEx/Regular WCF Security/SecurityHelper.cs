...
namespace ServiceModelEx
{
   public static class SecurityHelper
   {
      ...
      public static void SetSecurityBehavior(this ServiceHost host,ServiceSecurity mode,string serviceCertificateName,bool useAspNetProviders,string applicationName,bool impersonateAll) 
      {
