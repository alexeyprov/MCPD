...
static class Program
{
   ...
   //Permissions to use transactional queues and accept clients over MSMQ without security 
   [MessageQueuePermission(SecurityAction.PermitOnly,PermissionAccess = MessageQueuePermissionAccess.Receive,Path = QueueName)]
   [DistributedTransactionPermission(SecurityAction.PermitOnly,Unrestricted = true)]
