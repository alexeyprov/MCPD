...
namespace ServiceModelEx
{
   ...
   public static class CodeAccessSecurityHelper
   {
      ...
      public static PermissionSet Convert(IEnumerable<IPermission> permissions)
      {
      ...
      public static void SetPermissionsSet(AppDomain appDomain,PermissionSet permissions)
      {
      ...
      internal static void DemandHostPermissions(ServiceHost host)
      {
      ...
      public static void DemandClientPermissions<T>(ClientBase<T> proxy,string operationName) where T : class
      {
